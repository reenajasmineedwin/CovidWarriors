...
echo "<br><center><button style='background-color:#F7882F;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;'onclick=\"location.href='booking.html'\">Click to Reserve</center>";
